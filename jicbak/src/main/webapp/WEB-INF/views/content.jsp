...
<div class="jumbotron jumbotron-single d-flex align-items-center" style="background-image: url(../resources/img/bg.jpg)">
  <div class="container text-center">
    <h1 class="display-2 mb-4">Content</h1>
  </div>
</div>	<!-- Blog Section -->
                ...
                <div class="col-md-12 blog-holder">
                    <div class="row">
                        ...
                        <div class="col-md-4 blog-item-wrapper" data-aos="fade-up">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="/contentView"><img src="../resources/img/blog-1.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
                                    ...
                                    <div class="blog-title">
                                        <a href="/contentView"><h4>Amazing Blog Title</h4></a>
                                    </div>
                                    <div class="blog-meta">
                        ...
                        <div class="col-md-4 blog-item-wrapper" data-aos="fade-up" data-aos-delay="200">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="#"><img src="../resources/img/blog-2.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
                        ...
                        <div class="col-md-4 blog-item-wrapper" data-aos="fade-up" data-aos-delay="400">
                            <div class="blog-item">
                                <div class="blog-img">
                                    <a href="#"><img src="../resources/img/blog-3.jpg" alt=""></a>
                                </div>
                                <div class="blog-text">
                                    <div class="blog-tag">
