...
<div class="jumbotron jumbotron-single d-flex align-items-center; height: 20%;">
        ...
        <div class="section-content blog-content">
            ...
            <div class="row">
                ...
                <div class="col-md-8 offset-md-2 mt-4">
                    <h4 style="margin-bottom: 3%;">Lorem ipsum dolor sit amet</h4>
                    <p style="display: flex;  justify-content: space-between; align-items: center;">
                    <a>Writer : </a>
                    <a>Date : </a>
                    </p>
                    <img class="float-left" width="320px" src="../resources/img/blog-4.jpg" alt="">
