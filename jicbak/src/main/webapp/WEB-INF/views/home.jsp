...
<div class="jumbotron d-flex align-items-center">
  ...
  <div class="triangle triangle-1">
  	<img src="../resources/img/obj_triangle.png" alt="">
  </div>
...
<!-- End of Features Section-->	<section id="section-featurettes" class="featurettes overlay bg-fixed" style="background-image: url(../resources/img/bg.jpg);">
                ...
                <div class="col-md-12">
                    <div class="row align-items-center text-white">
                        ...
                        <div class="col-md-4 offset-md-right-2 col-sm-6" data-aos="flip-right">
                            <img class="my-5" src="../resources/img/app-profile-mockup.png" alt="">
...
<section id="testimonial" class="section-padding bg-fixed bg-white overlay" style="background-image: url(../resources/img/bg-white.jpg);">
    <div class="container">
                    ...
                    <div class="grid-portfolio">
                        ...
                        <div class="grid-item minimalism" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../resources/img/photo-1.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                        ...
                        <div class="grid-item vintage" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../resources/img/photo-6.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                        ...
                        <div class="grid-item creative grid-item-height" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../resources/img/photo-2.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                        ...
                        <div class="grid-item creative" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../resources/img/photo-7.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                        ...
                        <div class="grid-item vintage" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../resources/img/photo-4.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
                        ...
                        <div class="grid-item creative" data-aos="fade-up">
                            <div class="grid-item-wrapper">
                                <img src="../resources/img/photo-9.jpg" alt="portfolio-img" class="portfolio-item">
                                <div class="grid-info">
                                    <div class="grid-link d-flex justify-content-center">
...
<section id="client" class="overlay bg-fixed" style="background-image: url(../resources/img/bg.jpg);">
    <div class="container">
        <div class="section-content" data-aos="fade-up">
            <div class="row ">
                <div class="col-md-12">
                ...
                <div class="col-md-12 client-holder">
                    <div class="client-slider owl-carousel">
                        <div class="client-item">
                            <img class="img-responsive" src="../resources/img/client.png" alt=" ">
                        </div>
                        <div class="client-item">
                            <img class="img-responsive" src="../resources/img/client.png" alt=" ">
                        </div>
...
<section id="cta" class="bg-fixed overlay" style="background-image: url(../resources/img/bg.jpg);">
    <div class="container">
        <div class="section-content" data-aos="fade-up">
            <div class="row">
                <div class="col-md-12 text-center">
...
<footer class="mastfoot my-3">
	...
	<script src="../resources/vendor/bootstrap/popper.min.js"></script>
	<script src="../resources/vendor/bootstrap/bootstrap.min.js"></script>
	<script src="../resources/vendor/select2/select2.min.js "></script>
	<script src="../resources/vendor/owlcarousel/owl.carousel.min.js"></script>
	<script src="../resources/vendor/stellar/jquery.stellar.js" type="text/javascript" charset="utf-8"></script>
	<script src="../resources/vendor/isotope/isotope.min.js"></script>
	<script src="../resources/vendor/lightcase/lightcase.js"></script>
	<script src="../resources/vendor/waypoints/waypoint.min.js"></script>
	<script src="https://unpkg.com/aos@next/dist/aos.js"></script>
	<script src="../resources/vendor/header.js"></script>
